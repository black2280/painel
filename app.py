...
# -*- coding: utf-8 -*-
"""
Painel Black — SSH User Management Panel
"""
...
def inject_globals():
    return dict(
        ...
        panel_name=db.get_setting('panel_name', 'Painel Black'),
...
def _sync_renew_to_category(u):
    ...
    falhando silenciosamente. O próprio pblack_agent já faz "removessh"
...
def renew_user(user_id):
    ...
    if was_suspended:
        ...
        unlock_cmd = (
            ...
            f"/root/pblack_agent unblockuser {u['username']} 2>/dev/null || true"
        )
...
def suspend_user(user_id):
    ...
    if new_status == 'suspended':
        ...
        cmd = (
            ...
            f"/root/pblack_agent blockuser {u['username']} 2>/dev/null || true; "
