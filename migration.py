...
# -*- coding: utf-8 -*-
"""
migration.py — Import from Dragon Core/Atlas or GestorSSH MySQL dump into Painel Black (SQLite)
...
def migrate_dragon_core(sql_content: str) -> dict:
    """
    Parse MySQL dump from Dragon Core/Atlas and import into Painel Black.
    ...
    # ── 3. Get admin user id in Painel Black ──────────────────────────────
...
def migrate_gestor_ssh(sql_content: str) -> dict:
    """
    Parse MySQL dump from GestorSSH and import into Painel Black.
    Returns dict with counts of imported records.
