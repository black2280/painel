# -*- coding: utf-8 -*-
# pblack_module.py — Painel Black HTTP command receiver
# Port: 7270
...
class PBlackHandler(BaseHTTPRequestHandler):
...
server = HTTPServer(('0.0.0.0', 7270), PBlackHandler)
print('PanelBlack module iniciado na porta 7270')
