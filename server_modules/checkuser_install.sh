...
EOF
    ...
    echo ""
    echo -e "\e[1;32m📋 URLs para configurar no Painel Black (Configurações → CheckUser URL):\e[0m"
    ...
    echo ""
    echo -e "\e[1;36m⚠  Use a URL do Painel Black, não a do CheckUser externo!\e[0m"
    echo -e "\e[1;36m   O Painel Black já tem endpoint compatível com DTunnel embutido.\e[0m"
