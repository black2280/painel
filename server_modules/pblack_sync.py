#!/usr/bin/python3
# -*- coding: utf-8 -*-
# pblack_sync.py — Sync users to SSH server (CORRIGIDO)
...
if len(sys.argv) != 2:
    print("Uso: python3 pblack_sync.py <arquivo>")
    sys.exit(1)
...
for linha in linhas:
    ...
    if len(cols) >= 5:
        ...
        if primeiro_eh_uuid:
            ...
            os.system("/root/pblack_agent v2rayadd {} {} {} {} {}".format(
        ...
        os.system("/root/pblack_agent createssh {} {} {} {}".format(
